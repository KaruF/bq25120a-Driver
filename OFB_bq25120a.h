...
////// APPLICATION SPECIFIC INFORMATION - CAN BE CHANGED
...
#define APP_WDT_RESET_PERIOD            20                //Every 40 second reset watchdog timer with ı2c interface
#define SELECTED_WDT_RESET_TIMER        2
